    ...
    <body>
        ...
        <div id="main-container" class="container">
            <form id='updateCustomerForm' method="POST">
                ...
                Address: <br><input type="text" id="customer_address"> <br>
                <br>
                <button id="updateCustomerBtn" type="button" class='btn btn-primary'>update</button>
            </form>
        </div>
        ...
        <script>
            ...
            $("#updateCustomerBtn").click(function () {
                $(async () => {
                    ...
                    var serviceURL = "http://localhost:1000/customer/update/" + customer_mobile;
