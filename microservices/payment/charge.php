...
<html> 
    ...
    <body>
        ...
        <button id = 'updatePaymentStatusButton' class = 'btn btn-primary' href = '../booking/booking.php'> 
            Update Payment Status
        </button>
        <br>
        <a hrefclass = 'btn btn-primary' href = '../booking/booking.php?mobile_number=<?php echo $customerMobile ?>'> 
...
?>
                    ...
                    try {
                        ...
                        alert("Payment Successful! You may close this page or return to booking below!");
                    } catch (error) {
                        $('.errormsg').remove();
                        alert("Failed");
                    }
