                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Review for {service provider}</h5>
                            </div>
                            <div class="ibox-content">
                                <form id="" action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="customer_name">Review</label>
                                        <input type="textarea" class="form-control" name='course_code' placeholder="Write your review here" required>
                                    </div>
